import {
	...
	var ww = document.body.clientWidth/1;

	var euler = new Euler( 0, 0, 0, 'YXZ' );
	var xfromtouch = 0;
	var yfromtouch = 0;
	var PI_2_mobile = Math.PI / 10;
	var lastposx = null;
	var lastposy = null;
	...
	var PointerLockControls = function ( camera, domElement ) {
		...
		function onTouchMove( e ) {
		  	...
		  	latestposy = clientY;
		  	latestposx = clientX;
		  	xfromtouch = latestposx-ww;
			yfromtouch = latestposy-(h-100);
			...
			console.log("y position:"+yfromtouch);
		};
		function onTouchEnd( e ) {
			lastposx = xfromtouch;
			lastposy = yfromtouch;
			console.log("last y position:"+lastposy);
		  	// yfromtouch = euler.y;
		  	// xfromtouch = euler.x;
		};
